...
class UserProfile(QtWidgets.QWidget):
    ...
    def __init_ui(self) -> None:
        ...
        self.position_h_layout = QtWidgets.QHBoxLayout()
        ...
        self.position_label = QtWidgets.QLabel(text='Position')
    ...
    def __setting_ui(self) -> None:
        ...
        self.main_h_layout.addLayout(self.position_h_layout)
        ...
        self.position_h_layout.addWidget(self.position_label)
        ...
        self.position_h_layout.addWidget(self.position_line_edit)
        ...
        self.position_line_edit.setFixedWidth(150)
        ...
        [line_edit.setEnabled(False) for line_edit in (self.id_line_edit, self.login_line_edit, self.password_line_edit, self.confirm_password_line_edit, self.position_line_edit)]
    ...
    def fill_line_edits(self) -> None:
        ...
        self.position_line_edit.setText(str(self.parent.session.user.position))
